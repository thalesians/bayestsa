...
from thalesians.utilities.conditions import precondition, postcondition
...
class TestConditions(unittest.TestCase):
    ...
    def test_method_pre_and_postcondition1_order1(self):
    ...
    def test_method_pre_and_postcondition1_order2(self):
    ...
    def test_method_pre_and_postcondition1_order3(self):
